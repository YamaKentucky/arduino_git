...
void loop() {
  ...
  //deltaX_sum = deltaX_sum + deltaX * update_rate * 0.001 * altitude / scalar * 0.76772;
  //deltaY_sum = deltaY_sum + deltaY * update_rate * 0.001 * altitude / scalar * 0.76772;
  //deltaX_sum = deltaX_sum + deltaX * update_rate * 0.001 * range / scalar * 0.76772;
  //deltaY_sum = deltaY_sum + deltaY * update_rate * 0.001 * range / scalar * 0.76772;
