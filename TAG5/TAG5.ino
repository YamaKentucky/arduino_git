...
void newRange() {
  ...
  distance_e[0] = d0_old - distance[0];
//  Serial.print(abs(distance_e[0]));
//  Serial.print(",");
  if (abs(d0_old - distance[0]) < 8000 ) {
    d0_true = distance[0];
    d0_old = distance[0];
  }
